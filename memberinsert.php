...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $sql = "SELECT * FROM forummember WHERE username = ?";
    ...
    $sql = "SELECT * FROM forummember WHERE email = ?";
    ...
    if($errmsg == 1)
    {
        ...
        try{
            $sql = "INSERT INTO forummember (fname, lname, username, email, password, bio, phone, inputdate, updatedate)
