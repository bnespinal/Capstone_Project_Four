...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if($errmsg == 1)
    {
        ...
        try {
            //query the data
            $sql = "SELECT * FROM forum WHERE game LIKE '%{$formdata['term']}%' ORDER BY inputdate DESC";
            ...
            if ($stmt->rowCount() == 0) {
                ...
                echo "</table>";
                echo "<p id='statement'>Return to page to search again. <a href='http://ccuresearch.coastal.edu/bnespinal/csci409sp19/Project4/searchforum.php'>SEARCH</a></p>";
                $showform = 0;
            }
        }//try
...
if($showform ==1) {
    ...
    <form name="searchform" id="searchform" method="post" action="searchforum.php">
        <label for="term">Search Forum:</label><span class="error">*</span>
